...
(Really, it should be possible for a single drag to control *both* discrete and continuous dimensions, but DD doesn't support that yet. I'd love to have a good reason to do so.)
